...
docx_out = r"C:\Users\lap4all\Downloads\Ban_Do_Quy_Hoach_NTB_Perfect_v7.docx"
...
doc.save(docx_out)
print(f"Successfully created Final Perfect DOCX v7 at: {docx_out}")
...
doc_com.Close()
word.Quit()
print(f"Successfully generated PERFECT PDF V7 at: {pdf_out}")
