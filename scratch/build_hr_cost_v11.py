...
out_path = r'C:\Users\lap4all\Downloads\AOP_Hang_Nang_MAU_Vung_T7-T12_2026_final_v11.xlsx'

print("Đang tạo Bảng Định biên & Bảng Chi Phí Tinh Gọn (V11)...")
...
# --- BLOCK 1 (Cũ là Block 2): XỬ LÝ KHO ---
...
for i in range(4):
    sheet.cell(r, 1).value = hub_refs[i]
    kh_row = 18 + i*10 
    sox_r = block1_start_r + i # Dòng chứa nhân sự kho hiện tại
