...
ws = wb.active
ws.title = "Quy_Hoach_NTB_2026_Nha_Trang"
...
excel_out = r'C:\Users\lap4all\Downloads\Quy_Hoach_NTB_2026_Theo_Tinh_Nha_Trang_Chuan.xlsx'
wb.save(excel_out)
print(f"Generated Excel file: {excel_out}")
...
r_t = p_t.add_run('TỜ TRÌNH QUY HOẠCH MẠNG LƯỚI BƯU CỤC VÙNG NTB NĂM 2026\n(BẢNG TỔNG HỢP BỔ SUNG ĐẦY ĐỦ PHƯƠNG ÁN DI DỜI / MỞ RỘNG TẠI NHA TRANG & KHÁNH HÒA)')
...
word_out = r'C:\Users\lap4all\Downloads\Thu_trinh_Quy_Hoach_Mang_Luoi_NTB_2026_Nha_Trang_Chuan.docx'
doc_out.save(word_out)
print(f"Generated Word file: {word_out}")
