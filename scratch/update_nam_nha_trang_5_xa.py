...
# 5 Province Groups with 100% Exact Merged Ward Names directly from docx
province_data = [
    {
    ...
    },
    {
        ...
        "rows": [
            ["Phường Nam Nha Trang", "X. Vĩnh Thái + P. Phước Long + X. Phước Đồng + P. Phước Hải + P. Vĩnh Trường", "BC Nam Nha Trang 1 Mới & BC Nam Nha Trang 5", "Gộp về BC mới (ĐÓNG CỬA BC 2 & BC 3)"],
            ...
            ["Xã Diên Khánh", "TT. Diên Khánh + X. Diên An + X. Diên Toàn", "BC (KHO) Diên Khánh 2", "Gộp về BC Diên Khánh 2 (ĐÓNG CỬA BC DK1 <40m²)"],
            ...
            ["Xã Hòa Trí", "X. Ninh Trung + X. Ninh Thân + X. Ninh Thượng", "BC Ninh Hòa 1 & BC Ninh Hòa 2", "GIỮ NGUYÊN 02 BƯU CỤC chia tuyến cover"],
            ["Xã Tân Định", "X. Ninh Quang + X. Ninh Bình + X. Ninh Xuân", "BC Ninh Hòa 1 & BC Ninh Hòa 2", "GIỮ NGUYÊN 02 BƯU CỤC phụ trách chia tuyến"]
        ]
    },
    {
    ...
    },
    {
        ...
        "rows": [
            ...
            ["Xã Phan Rí Cửa", "TT. Phan Rí Cửa + X. Chí Công + X. Hòa Minh + X. Phong Phú", "BC Phan Rí Cửa & BC Liên Hương", "GIỮ NGUYÊN 02 BƯU CỤC cover song song"],
    ...
    },
    {
        ...
        "rows": [
            ...
            ["Xã Đức An", "TT. Đức An + X. Đắk N'Drung + X. Nam Bình", "BC Đức An & BC Trường Xuân", "GIỮ NGUYÊN BC Đức An & BC Trường Xuân (gần kho hơn)"],
...
excel_out = r'C:\Users\lap4all\Downloads\Bang_Quy_Hoach_NTB_2026_Theo_Tinh_Chuan_5_Xa.xlsx'
wb.save(excel_out)
print(f"Updated Excel file with 5 wards for Nam Nha Trang: {excel_out}")
...
word_out = r'C:\Users\lap4all\Downloads\Bang_Quy_Hoach_NTB_2026_Theo_Tinh_Chuan_5_Xa.docx'
doc_out.save(word_out)
print(f"Updated Word file with 5 wards for Nam Nha Trang: {word_out}")
