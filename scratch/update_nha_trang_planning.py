...
maps_data = [
    {
        ...
        "items": [
            ("1.1. Quy hoạch Cụm Bưu cục TP. Nha Trang (Biến động 07 Bưu cục)",
             "Chi tiết phương án quy hoạch các Bưu cục khu vực Nha Trang khi sáp nhập ĐVHC:\n"
             "  • Giữ lại (03 BC): (KHO) Bắc Nha Trang, (KHO) Tây Nha Trang, (KHO) Nam Nha Trang 5.\n"
             "  • Di dời (02 BC): (KHO) Nha Trang, (KHO) Nam Nha Trang 1.\n"
             "  • Đóng cửa / Gộp phân vùng (02 BC): (KHO) Nam Nha Trang 2, (KHO) Nam Nha Trang 3.",
             os.path.join(artifact_dir, "image4.png")),
            ("1.2. Bản đồ Kế hoạch Tách Bưu cục Cam Linh & Bắc Cam Ranh", 
...
doc_com.Close()
word.Quit()
print(f"Successfully generated MAPS-ONLY PDF with Nha Trang updates at: {pdf_out}")
