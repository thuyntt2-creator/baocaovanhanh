...
docx_out = r"C:\Users\lap4all\Downloads\Ban_Do_Quy_Hoach_NTB_Perfect_v5.docx"
pdf_out = r"C:\Users\lap4all\Downloads\Ban_Do_Quy_Hoach_Mang_Luoi_NTB_2026.pdf"

infographic_img = os.path.join(artifact_dir, "don_duong_official_infographic.png")
...
r_sub = p_sub.add_run("BẢN ĐỒ KHOANH VÙNG CHUẨN TRÍCH XUẤT TỪ HỆ THỐNG ANH THIÊN (quyhoachbuucuc.info)")
r_sub.bold = True
...
sections = [
    ...
    },
    {
        ...
        "items": [
            {
                "title": "2.1. Infographic & Bản đồ Phân vùng Tách Bưu cục Lạc Xuân - Huyện Đơn Dương",
                "img": infographic_img,
...
doc.save(docx_out)
print(f"Successfully created Final Perfect DOCX v5 at: {docx_out}")
...
doc_com.Close()
word.Quit()
print(f"Successfully generated PERFECT PDF V5 at: {pdf_out}")
