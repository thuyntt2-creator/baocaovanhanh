...
out_path = r'C:\Users\lap4all\Downloads\AOP_Hang_Nang_MAU_Vung_T7-T12_2026_final_v12.xlsx'

print("Đang tạo Báo cáo so sánh Lý thuyết & Thực tế (V12)...")
...
for c_idx in range(6):
    sheet.cell(12, c_idx+2).value = f"=SUM({cols[c_idx]}{block1_start_r}:{cols[c_idx]}{block1_start_r+3})"
