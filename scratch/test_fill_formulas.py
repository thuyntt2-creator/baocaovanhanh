...
# Column mapping for months in NTB - Input (Col D to I)
# Column mapping for months in Định biên & Sản lượng (Col I to N)
# Column mapping for months in Chi phí FLM (Col J to O)
