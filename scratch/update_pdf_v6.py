...
docx_out = r"C:\Users\lap4all\Downloads\Ban_Do_Quy_Hoach_NTB_Perfect_v6.docx"
...
r_sub = p_sub.add_run("BẢN ĐỒ KHOANH VÙNG RANH GIỚI & CHÚ GIẢI TRÊN NỀN WEB ANH THIÊN (quyhoachbuucuc.info)")
r_sub.bold = True
...
doc.save(docx_out)
print(f"Successfully created Final Perfect DOCX v6 at: {docx_out}")
...
doc_com.Close()
word.Quit()
print(f"Successfully generated PERFECT PDF V6 at: {pdf_out}")
