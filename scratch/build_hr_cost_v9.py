...
out_path = r'C:\Users\lap4all\Downloads\AOP_Hang_Nang_MAU_Vung_T7-T12_2026_final_v9.xlsx'

print("Đang tạo Bảng Định biên & Bảng Chi Phí (V9)...")
...
# --- BLOCK 1: NGƯỜI GIAO ---
sheet.cell(r, 1).value = "I. ĐỊNH BIÊN NGƯỜI GIAO (TÀI XẾ + PHỤ XE) THEO KHO/BC (Của NCC)"
...
# --- BLOCK 2: XỬ LÝ KHO ---
r += 1
sheet.cell(r, 1).value = "II. ĐỊNH BIÊN NHÂN VIÊN XỬ LÝ KHO (SOX) THEO KHO/BC (Đã cộng 3 NVXL cứng mỗi kho)"
sheet.cell(r, 1).font = Font(bold=True, color="FF0000")
r += 1
...
for i in range(4):
    ...
    for c_idx, m in enumerate(months):
        ...
        fc_row = i + 4 
        # Cập nhật logic: 3 (Bộ khung cứng) + Số lượng bốc vác
